...
class DistilBertEmotionClassifier:
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained("RAG/Helpers/Model/final_mental_emotion_model")
        self.model = AutoModelForSequenceClassification.from_pretrained("RAG/Helpers/Model/final_mental_emotion_model")
