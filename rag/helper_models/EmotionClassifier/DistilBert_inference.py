...
class EmotionClassifier:
    def __init__(self):
        self.tokenizer = AutoTokenizer.from_pretrained("rag/helper_models/model_objs/final_mental_emotion_model")
        self.model = AutoModelForSequenceClassification.from_pretrained("rag/helper_models/model_objs/final_mental_emotion_model")
        self.classifier = pipeline("text-classification", model=self.model, tokenizer=self.tokenizer, return_token_type_ids=False)
        self.label_map = {
            0: "sadness",
            1: "joy",
            2: "love",
